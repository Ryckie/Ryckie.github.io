...
<li><a href="#member-only-commands----">— Member only commands —</a></li>
  ...
  <div class="stackedit__right">
    <div class="stackedit__html">
      <p><img src="https://imgur.com/MqOzqSD.png" alt=""></p>
...
<li><code>!clear &lt;member&gt; [ammount]</code> - Clear x messages in the current channel. (Mention a member to delete x amount of messages from that member only.</li>
</ul>
...
<li><code>!clear</code> - Clears the queue.</li>
